...
export class ProdutosPage {
  ...
  add(){
    this.navCtrl.push('ProdutosAddPage')
  }
      ...
      buttons: [                                            
        {
          ...
          icon: !this.platform.is('ios') ? 'md-clipboard' : null,
          handler: () => {
            console.log('edit clicked');
            this.navCtrl.push('ProdutosAddPage', {payload: payload_})
          }
        },
        {
  ...
  removeUserContinue(payload_){  
    ...
    this.db.removerProduto(payload_)
    .then(() => {
      loading.dismiss()
  ...
  async realizarSorteioContinue(payload_){
      ...
      this.db.adicionaSorteio(payload_.key)
      .then(() => {


        loading.dismiss()
        this.uiUtils.showAlertSuccess('Sorteio realizado com sucesso. Favor aguarde alguns instantes!')
